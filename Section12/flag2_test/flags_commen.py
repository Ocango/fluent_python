...
def process_args(default_concur_req):
    ...
    parser.add_argument('-m','--max_req',metavar = 'CONCURRENT',type = int,default = default_concur_req,help='maximun concurrent requests (default={})'.format(default_concur_req))
    parser.add_argument('-s','--server',metavar = 'LABEL',default = DEFAULT_SERVER,help = 'Server to hit; one of {} (default=a{})'.format(server_options,DEFAULT_SERVER))
